...
datadir='/gpfs/f5/scratch/Luan.Santos/gfdl_w/solo_'+hydro+'/'
graphdir = '/gpfs/f5/scratch/Luan.Santos/gfdl_w/graphs_solo_'+hydro+'/'
#----------------------------------------------------------------------------------------------
    ...
    for tile in range(0,6):
       ...
       for t in range(0,nplots+1,tgap):
           ...
           #   pv[:,:,tile,t,k] = data['pv'][t-1,:,:].values
               u[:,:,tile,t,k] = data['u500'][t-1,:,:].values
               v[:,:,tile,t,k] = data['v500'][t-1,:,:].values
               vort[:,:,tile,t,k] = data['vort500'][t-1,:,:].values
           #   pv[:,:,tile,t,k] = data['pv'][t-1,:,:].values
           else: #get ic
               print('hi')
...
ax.set_title(' Coliding modons - '+gname+ ', N='+str(N)+', hord='+str(hord)+'\n' \
