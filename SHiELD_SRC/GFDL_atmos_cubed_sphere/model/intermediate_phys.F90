...
module intermediate_phys_mod
    ...
    use fv_arrays_mod, only: fv_grid_type, fv_grid_bounds_type, fv_flags_type, inline_mp_type
...
subroutine intermediate_phys (is, ie, js, je, isd, ied, jsd, jed, km, npx, npy, nq, nwat, &
               ...
               gridstruct, flagstruct, domain, bd, hydrostatic, do_adiabatic_init, &
...
!$OMP                                    te_end, tw_end, te_b_end, tw_b_end, te_loss)
    ...
    if ((.not. do_adiabatic_init) .and. do_inline_mp .and. nwat .eq. 6) then
        ...
        call cubed_to_latlon (u, v, ua, va, gridstruct, flagstruct, npx, npy, km, 1, gridstruct%grid_type, &
