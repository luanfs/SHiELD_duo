...
module fv_mapz_mod
  ...
  use fv_arrays_mod,     only: fv_grid_type, fv_grid_bounds_type, fv_flags_type, R_GRID, inline_mp_type
...
contains
 ...
 subroutine Lagrangian_to_Eulerian(last_step, consv, ps, pe, delp, pkz, pk,   &
                      ...
                      ptop, ak, bk, pfull, gridstruct, flagstruct, domain, do_sat_adj, &
...
!-----------------------------------------------------------------------
    ...
    call intermediate_phys (is, ie, js, je, isd, ied, jsd, jed, km, npx, npy, nq, nwat, &
             ...
             inline_mp, gridstruct, flagstruct, domain, bd, hydrostatic, do_adiabatic_init, &
